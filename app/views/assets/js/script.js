...
function roll(){
	...
	if (!gameover) {	
		for (var i = 1; i < 4; i++) {			
			...
			document.getElementById("dice"+[i]).src = "/Edvinas/gameMVC/app/views/assets/images/" + x + ".jpg";
			skaiciai.push(x);
		}
	...
	function check_gameover() {
		if (lucky.length < 4) {
			...
			if (total > 0) {
				document.getElementById("prize").src = "/Edvinas/gameMVC/app/views/assets/images/win.jpg";
			} else {
				document.getElementById("prize").src = "/Edvinas/gameMVC/app/views/assets/images/lose.jpg";
			}
			gameover = true;
			kelk();
